...
Subject: A stern cartoon bouncer character with a name badge reading CORE AI plants one arm to fling open a heavy roped-off club door and sweeps the other arm to wave in an eager line of small mismatched model-creatures, the front two carrying little luggage tags lettered LLAMA and MISTRAL, motion lines on the swinging door and the hurrying line; off to the side a stiff, glum old doorman with a CORE ML badge shuffles away hugging a cardboard box, slumped shoulders.
