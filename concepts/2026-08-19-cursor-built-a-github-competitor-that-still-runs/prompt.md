...
Hook overlay: CURSOR'S GITHUB COMPETITOR STILL RUNS ON GITHUB
Metaphor: A frantic cartoon engineer pumps a rail handcar labeled ORIGIN at full speed, sweat flying, while the railroad ties beneath the track are each stamped GITHUB.
...
Subject: A frantic engineer pumping a small rail handcar at full speed down a track, the handcar's side panel lettered ORIGIN, speed lines and flying sweat drops showing the effort, mouth open mid-strain. Beneath the wheels, the railroad ties are each clearly stamped GITHUB, so the racer is winning on a track it does not own.
