...
- Does firsthand work promote a t0 subject to t1 reliably, or only when the artifact is something another builder can run? Currently one exemplar, so the rule is asserted rather than shown.
